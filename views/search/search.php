              ...
              <div class="col-md-12 col-lg-12 mb-5">
                <div class="block-20 ">
                  <figure style="padding: 10px;">
                    <a href=""><img src="/../template/images/<?=$search['img']?>" alt="" class="img-fluid" style="width: 100%; height: 300px;"></a>
                  </figure>
                  <div class="text">
                    <h3 class="heading"><a href=""><?=$search['name']?></a></h3>
                    <p><?=$search['text']?></p>
                    <div class="meta">
                      <div><span class="ion-android-calendar"> <?=$search['date_added']?></span></div>
                      <div><span class="ion-android-person"> <?=$search['author']?></span></div>
                      <div><span class="fa fa-eye"> <?=$search['keyss']?></span></div>
                    </div>
                  </div>
                </div>
              </div>
